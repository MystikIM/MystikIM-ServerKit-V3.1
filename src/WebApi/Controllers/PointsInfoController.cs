...
namespace SdtdServerKit.WebApi.Controllers
{
    ...
    public partial class PointsInfoController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Post([FromBody] PointsInfo model)
        {
            ...
            Managers.PointLogger.Log(Models.PointLogCategory.WebApi, model.Id, model.PlayerName,
                model.Points, model.Points, "Web 面板：新增积分记录",
        ...
        public async Task<IHttpActionResult> Put(string id, [FromBody] PointsInfo model)
        {
            ...
            int diff = model.Points - entity.Points;
            ...
            if (diff != 0)
            {
                Managers.PointLogger.Log(Models.PointLogCategory.WebApi, id, model.PlayerName,
                    diff, model.Points, "Web 面板：手动调整积分",
                    Models.PointChangeType.Set);
            }
            return Ok();
        }

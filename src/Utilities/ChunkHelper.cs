...
namespace SdtdServerKit.Utilities
{
    ...
    public static class ChunkHelper
    {
        ...
        public static int AddPrefabToRWG(Prefab prefab, Vector3i offsetPosition)
        {
            ...
            dynamicPrefabDecorator.allPrefabs.Add(prefabInstance);
            dynamicPrefabDecorator.poiPrefabs.Add(prefabInstance);
        ...
        {
            var dynamicPrefabDecorator = GameManager.Instance.GetDynamicPrefabDecorator();
            var dynamicPrefabs = dynamicPrefabDecorator.allPrefabs;
            var POIPrefabs = dynamicPrefabDecorator.poiPrefabs;
